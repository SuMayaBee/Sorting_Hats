...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'TTS',
          path: '/tts',
          builder: (context, params) => const TtsWidget(),
        ),
        FFRoute(
          name: 'ContiniousVision',
          path: '/continiousVision',
          builder: (context, params) => const ContiniousVisionWidget(),
        ),
        FFRoute(
          name: 'HomePageCopy',
          path: '/homePageCopy',
        ...
        FFRoute(
          name: 'TTSCopy',
          path: '/tTSCopy',
          builder: (context, params) => const TTSCopyWidget(),
        ),
        FFRoute(
